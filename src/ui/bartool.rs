...
impl BarTool {
    ...
    /// Renderiza a barra de transporte como um widget inline (sem Area).
    /// Deve ser chamado dentro do Ui onde a barra deve aparecer.
    pub fn show_inline(&mut self, ui: &mut Ui) {
