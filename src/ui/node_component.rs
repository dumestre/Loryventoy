...
const HOVER_VERDE: Color32 = Color32::from_rgba_premultiplied(16, 31, 19, 40);
const HOVER_VERMELHO: Color32 = Color32::from_rgba_premultiplied(39, 16, 16, 50);
